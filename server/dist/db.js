...
db.exec(`UPDATE affiliation_requests SET requested_address_type = 'coworking' WHERE requested_address_type = 'affiliation'`);
...
if (count === 0) {
    ...
    ) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)`).run(r1, null, "coworking", "上海市静安区", "赵晨", "", "集中办公区", "pending", "年度续签挂靠服务", "channel", 0, "渠道王", "13800001111", "渠道李", "13800002222", "https://example.com/id-front-demo.jpg", "https://example.com/id-back-demo.jpg", "法人张", "13900003333", "上海市浦东新区张江路1号", "zhang@example.com", "企业备周", "13900004444", null, "user_sales", t, t, t, null, null, null);
}
